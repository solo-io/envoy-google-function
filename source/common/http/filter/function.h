...
struct GFunction {
  ...
  Function()
      : name_(nullptr), host_(nullptr),
        region_(nullptr), project_(nullptr), func_name_(nullptr) {}

  Function(const std::string *name, const std::string *host, const std::string *region,
